...
<table>
	...
	<tr>
		<th><h4><a href="<%= request.getContextPath() %>/back-end/report_detail/select_page.jsp"><img src="<%= request.getContextPath() %>/back-end/report_detail/images/back1.gif" width="100" height="32" border="0"></a></h4></th>
		<th>文章檢舉編號</th>
		<th>檢舉者會員編號</th>
		<th>文章編號</th>
		<th>處理狀態</th>
	...
	<tr>
		<td><h4><a href="<%= request.getContextPath() %>/back-end/report_detail/select_page.jsp">回首頁</a></h4></td>
		...
		<td><%=reportdetailVO.getEmpno()%></td>
		<td><%=reportdetailVO.getReportlmod()%></td>
