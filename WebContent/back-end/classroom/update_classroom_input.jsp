                        ...
                        <div class="col-md-4">
                            ...
                            <form METHOD="post" ACTION="<%=request.getContextPath()%>/classroom/classroom.do" name="form1">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                        name="roomname" value="${classroomVO.roomname}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control roomSpace" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                        min="1" max="10" id="roomrow" name="roomrow" value="${classroomVO.roomrow}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control roomSpace" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"
                                        min="1" max="10" id="roomcolumn" name="roomcolumn" value="${classroomVO.roomcolumn}">
                                </div>
                                ...
                                <button type="submit" class="bttn" type="submit">送出修改</button>
