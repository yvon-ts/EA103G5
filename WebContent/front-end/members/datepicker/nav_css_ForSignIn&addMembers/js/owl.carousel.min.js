...
function(a, b, c, d) {
    ...
    e.Defaults = { nav: !1, navText: ['<span aria-label="Previous">' + '<i class="lni-pointer-left"></i>' + '&emsp;</span>', '<span aria-label="Next">&emsp;' + '<i class="lni-pointer-right"></i>' + '</span>'], navSpeed: !1, navElement: 'button type="button" role="presentation"', navContainer: !1, navContainerClass: "owl-nav", navClass: ["owl-prev", "owl-next"], slideBy: 1, dotClass: "owl-dot", dotsClass: "owl-dots", dots: !0, dotsEach: !1, dotsData: !1, dotsSpeed: !1, dotsContainer: !1 }, e.prototype.initialize = function() {
