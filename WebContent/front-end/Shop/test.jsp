...
<body>
	...
	<section id="services" class="section-padding">
		<div class="content">
			<h1>Shopping Cart</h1>
			<p>Update quantities or remove items from your cart. When you are
				ready to checkout, click the &ldquo;Checkout Now&rdquo; button.</p>
					...
					<tr>
						<td>
							<div class="item">
								...
								<%=order.getCourseno()%><br />
							<p class="description">info info info</p>
						</td>
						<td><%=order.getSellprice() %></td>
					</tr>
