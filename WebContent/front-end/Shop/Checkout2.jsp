								...
								<div class="checkoutArea">
									...
									<div class="row mt-4 d-flex align-items-center">
										<div class="col-sm-6 order-md-2 text-right">
											...
											<form method="post"
												action="<%=request.getContextPath()%>/Order_Master/Order_Master.do" id="myForm">
												<input type="hidden" name="action" value="insert">
												<input type="hidden" name="memno" value="<%=membersVO.getMemno()%>"> 
												<input type="hidden" name="orderamt" value="${totalPrice}">要使用折扣券嗎
												<select name="coupno">
												...
												<a href="<%=request.getContextPath()%>/front-end/Shop/Checkout.jsp"><button type="button" class="btn btn-primary" id= "checkout">前往結帳</button></a>
											</form>
										</div>
										<div class="col-sm-6 mb-3 mb-m-1 order-md-1 text-md-left">
											<a href="<%=request.getContextPath()%>/front-end/course/listAllCourseForUser.jsp">
											<i class="fa fa-undo" aria-hidden="true"></i>&nbsp;&nbsp;Continue shopping
											</a>
										</div>
									</div>
								</div>
