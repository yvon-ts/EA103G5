...
<%@ page
	import="com.tracking_list.model.*,com.course.model.*,java.util.*,com.members.model.*"%>
			...
			<div class="section-header">
				<h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">
					<i class="fa fa-shopping-cart" aria-hidden="true"
						style="font-size: 25px"></i>&nbsp;My Cart
				</h2>
				&nbsp;&nbsp;<i class="text-info font-weight-bold"><span
					id="number"><%= productNumber%></span></i> items in your cart <input
					type="hidden" id="shoppingCartSize" value="<%= productNumber%>" />
				...
				<c:if test="${empty shoppingList}">
					<div class="shoppingCartArea">
						...
						<button class="btn btn-common"
							onclick="location.href='<%=request.getContextPath()%>/front-end/course/listAllCourseForUser.jsp'"
							style="margin-top: 3%;">搜尋課程</button>
					</div>
								...
								<div class="col-lg-12 col-md-12 col-12">
									...
									<table id="shoppingCart"
										...
										<tbody>
											...
											<c:forEach var="courseVO" items="${shoppingList}"
												varStatus="counter">
												<tr>
													<td data-th="Product">
														<div class="row">
															<div class="col-md-3 text-left">
																<img
																	src="<%=request.getContextPath()%>/course/CoursePictureReaderFromDB?courseno=${courseVO.courseno}"
																	alt=""
													...
													<c:set var="totalPrice"
														value="${totalPrice + courseVO.courseprice}" />

													<td class="actions" data-th="">
														<div class="text-right">
															<input type="hidden" id='courseprice${counter.count}'
																value="${courseVO.courseprice}" />
															<button type="button" class="btn btn-danger"
																id="remove${counter.count}">Remove</button>
															<input type="hidden" name="courseno${counter.count}"
																id='courseno${counter.count}'
							...
							<div class="row mt-4 d-flex align-items-center">
								...
								<div class="col-sm-6 mb-3 mb-m-1 order-md-1 text-md-left">
									<a
										...
										<i class="fa fa-undo" aria-hidden="true"></i>&nbsp;&nbsp;Continue
										Shopping
									</a>
								</div>
							</div>
...
<<<<<<< HEAD
	...
	<section id="services" class="section-padding" style="padding: 90px 0">
		<div class="container">
			<div class="section-header">
				<h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">
					<i class="fa fa-heart" aria-hidden="true" style="font-size: 25px"></i>&nbsp;追蹤清單
				</h2>
				<div class="title wow fadeInDown" data-wow-delay="0.3s"></div>

				<div class="row trackingArea"></div>
				<div align="center">
					<button class="btn btn-common" id="js-load-more">載入更多</button>
				</div>
			</div>
		</div>
	</section>
