...
<title>取消追蹤 - deleteTracking.jsp</title>
...
<br>
<input type="hidden" name="reportno" value="<%=trackinglistVO2.getMemno()%>"/>
<input type="hidden" name="reportno" value="<%=trackinglistVO2.getCourseno()%>"/>
<input type="hidden" name="action"	value="delete">
<input type="submit" value="取消追蹤"></FORM>
