...
<script
	...
	type="text/javascript"></script>
        ...
        <link href="<%=request.getContextPath()%>/front-end/teacher/teacher_css/styles.css" rel="stylesheet" />
...
<!--         </nav> -->
        ...
        <header class="masthead">
            ...
            <div class="container h-100">
                <video id="" src="<%=request.getContextPath()%>/front-end/teacher/teacher_css/img/portfolio/video.mp4" autoplay controls muted loop></video>
                ...
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="<%=request.getContextPath()%>/front-end/teacher/teacherRegister.jsp">申請成為老師</a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <ul>
                            <li> <p class="text-white-50 mb-4">完成老師開課申請，簡單幾步驟創造你的課程提案，Xducation 將會審核課程，讓你朝下一個目標邁進。</p></li>
                            <li> <p class="text-white-50 mb-4">準備優質課程內容，
當你的知識技能點亮每個人的生活，讓學生再次體驗純粹的熱情，將會有越來越多人加入你的課程。</p></li>
 <li> <p class="text-white-50 mb-4">持續創造教學生態圈，每個階段隨時掌控與學生的交流，回答問題或提供鼓勵，一起滿足學習渴望，得到分享的充實。</p></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h6>來自各地的學生</h6>
                            <p class="text-muted mb-0">395,000+ 名註冊會員遍及全台，更有遠從馬來西亞、香港、新加坡…等各地學生加入 Xducation。沒有時間地域限制，線上學習的需求遠超乎你的想像。</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h6>最高售課分潤</h6>
                            <p class="text-muted mb-0">每一筆由老師銷售出的課程，老師會獲得高達 90% 的分成，由 Xducation 售出則獲得 50% 的分成。交易資訊公開透明，後台系統可以隨時查看明細。</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <h6>募資成功率</h6>
                            <p class="text-muted mb-0">跨出勇敢的第一步，高達 93% 的募資成功率，在 Xducation 開課賺取你的夢想基金！2015 年 2 月上線至今，有 3 位賺取超過百萬、1 位破千萬的老師，被動收入持續累積中。</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row no-gutters">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/1.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/1.jpg" alt="" />
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/2.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/2.jpg" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">2.編輯提案</div>
                                <div class="project-name">安排時間擬定課程架構，拍攝1~3分鐘的募資影片，Step by Step完成提案！更多開課小撇步請參考Xducation開課教學系列文章</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/3.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/3.jpg" alt="" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/4.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/4.jpg" alt="" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/5.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/5.jpg" alt="" />
                            <div class="portfolio-box-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/6.jpg">
                            <img class="img-fluid" src="teacher_css/img/portfolio/thumbnails/6.jpg" alt="" />
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                 ...
                 <p>想和我們一起更完整地打造獨一無二的課程嗎？<br>歡迎申請 Xducation 專業的「課程製作服務」，通過審核後，我們將提供編輯提案與課程攝影服務，讓 Xducation 助你一臂之力。</p>
