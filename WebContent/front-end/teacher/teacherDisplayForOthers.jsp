...
<jsp:useBean id="teacherSvc1" scope="page" class="com.teacher.model.TeacherService" />
<jsp:useBean id="membersSvc" scope="page" class="com.members.model.MembersService" />


<%
String tchrno1 = (String)request.getParameter("tchrno");
pageContext.setAttribute("tchrno",tchrno1);
...
<!--         </nav> -->
 ...
 <div class="tabs">
  ...
  <div id="tab01" class="tab-contents">
   <h2  class="form-title">${membersSvc.getOneMembers(teacherSvc.getOneTeacher(tchrno).memno).memname}<img class="pic" src="<%=request.getContextPath()%>/front-end/teacher/teacherRegister_css/images/teacher.svg"></h2>
               <h5 class="h5">${membersSvc.getOneMembers(teacherSvc.getOneTeacher(tchrno).memno).nkname}</h5>         
    <div class="signup-content">
                    ...
                    <div class="signup-form">
                            ...
                            <div class="form-group">
                                ...
                                <p>點選可放大檢視</p>
                                <table id="license">
                                <th><img  class="pimg" src="<%=request.getContextPath()%>/front-end/teacher/TchrcertDisplayServlet1?TCHRNO=${tchrno}" ></th>
                                <th><img  class="pimg" src="<%=request.getContextPath()%>/front-end/teacher/TchrcertDisplayServlet2?TCHRNO=${tchrno}" ></th>
    ...
    <div id="innerdiv" style="position:absolute;">
        <img id="bigimg" style="border:5px solid #fff;" src="" />
                    ...
                    <div id="mpic"><img id='mprofile' src="<%=request.getContextPath()%>/front-end/members/MprofileDisplayServlet?MEMNO=${teacherSvc.getOneTeacher(tchrno).memno}" alt="sing up image">
                   </div>
  ...
  <div id="tab02" class="tab-contents">
    <h2 >關於我<img class="pic" src="<%=request.getContextPath()%>/front-end/teacher/teacherRegister_css/images/reunion.svg"></h2>
       <p>${teacherSvc.getOneTeacher(tchrno).tchrintro}</p>                      
    
  </div>
  <div id="tab03" class="tab-contents">
    	<h2>${membersSvc.getOneMembers(teacherSvc.getOneTeacher(tchrno).memno).memname}-所開設的課程</h2>    
    	<% 
    	Map<String, String[]> map = new TreeMap<String, String[]>();
    	map.put("tchrno", new String[]{tchrno1});
