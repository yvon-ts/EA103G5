...
<!--         </nav> -->
    ...
    <div class="main">
      <input type="hidden" id="starter" value="${teacherSvc.getOneTeacher(teacherSvc.getStatus(membersVO.memno).tchrno).rejreason}">
            ...
            <div class="container" id="bg">
                <div class="signup-content">
                    ...
                    <div class="signup-form">
                        ...
                        <h2  class="form-title">再次遞交申請<img id="pic" src="<%=request.getContextPath()%>/front-end/teacher/teacherRegister_css/images/teacher.svg"></h2>
                            ...
                            <div class="form-group">
                               ...
                               <textarea  name="tchrintro">${teacherSvc.getOneTeacher(teacherSvc.getStatus(membersVO.memno).tchrno).tchrintro}</textarea>
                            </div>
                    ...
                    <div class="signup-image">
                        ...
                        <figure class='license'><img id="license1" class="certification" src="<%=request.getContextPath()%>/front-end/teacher/TchrcertDisplayServlet1?TCHRNO=${teacherSvc.getStatus(membersVO.memno).tchrno}" ></figure>
