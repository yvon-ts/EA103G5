...
public class PostsJNDIDAO implements PostsDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT POSTNO, SUPERPOSTNO, COURSENO, MEMNO, POSTCONTENT, POSTTIME FROM POSTS ORDER BY POSTNO";
	private static final String GET_ONE_STMT = "SELECT POSTNO, SUPERPOSTNO, COURSENO, MEMNO, POSTCONTENT, POSTTIME FROM POSTS WHERE POSTNO = ?";
