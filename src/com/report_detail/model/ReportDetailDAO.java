...
public class ReportDetailDAO implements ReportDetailDAO_interface {
	...
	private static final String INSERT_STMT = "INSERT INTO REPORT_DETAIL(REPORTNO, MEMNO, POSTNO, REPORTLMOD) VALUES (('REPO'|| LPAD(SEQ_REPORTNO.NEXTVAL, 4, 0)), ?, ?,CURRENT_TIMESTAMP)";
	...
	private static final String DELETE_REPORT = "DELETE FROM REPORT_DETAIL WHERE REPORTNO = ?";
