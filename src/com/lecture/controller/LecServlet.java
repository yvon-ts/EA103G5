	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//====================================開始新增(無圖片)====================================//
				if ("insertText".equals(action)) {
					...
					/***********************驗證完畢***********************/	
						LecService lecSvc = new LecService();
						lecVO = lecSvc.addLecText(lecname, lecprice, spkrno, roomno, lecstart, lecend, signstart, signend, initseat, currseat, lecinfo);
		...
		//====================================開始修改====================================//
				...
				if ("updateText".equals(action)) {
					...
					/***********************驗證完畢***********************/	
						LecService lecSvc = new LecService();
						lecVO = lecSvc.updateText(lecno, lecname, lecprice, spkrno, roomno, lecstart, lecend, signstart, signend, initseat, currseat, lecstatus, lecinfo);
